...
frm.inDetalhes.addEventListener("focus", () => { // quando campo recebe foco
...
frm.inDetalhes.addEventListener("blur", () => {  // quando campo perde o foco
    frm.inDetalhes.placeholder = "" // limpa a dia de preenchimento
})
...
frm.addEventListener("submit", (e) => {
    ...
    if (frm.rbPizza.checked) {
        ...
        produto = frm.inPizza.option[num].text // texto do item selecionado
    } else {
